...
const BLOCKLIST_URL = 'https://serverless-edge-dns-gateway-v2-1ta.pages.dev/rules/blocklists.txt';
const ALLOWLIST_URL = 'https://serverless-edge-dns-gateway-v2-1ta.pages.dev/rules/allowlists.txt';
...
const PRIVATE_TLD_URL = 'https://serverless-edge-dns-gateway-v2-1ta.pages.dev/rules/private_tlds.txt';

// DNS redirect/rewrite (local CNAME overrides)
const DNS_REDIRECT_ENABLED = true;
const REDIRECT_RULES_URL = 'https://serverless-edge-dns-gateway-v2-1ta.pages.dev/rules/redirect_rules.txt';

// Dedicated Mullvad Upstream Domains
const MULLVAD_UPSTREAM_ENABLED = true;
const MULLVAD_UPSTREAM_URL = 'https://serverless-edge-dns-gateway-v2-1ta.pages.dev/rules/mullvad_upstream.txt';
